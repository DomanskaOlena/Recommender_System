...
from .discretize import (BaseDiscretizer, QuartileDiscretizer,
                         StatsDiscretizer)
...
class LimeTabularExplainer(object):
    ...
    def __init__(self,
        ...
        if discretize_continuous and not sp.sparse.issparse(training_data):
            ...
            # print(training_data.shape, 'we are here')
    ...
    def explain_instance_find_optimal(self,
                         data_row,
                         predict_fn,
                         labels=(1,),
                         top_labels=None,
        ...
        # print(inverse, not_optimize_data)
        yss = predict_fn(self.general_model, inverse, not_optimize_data)
